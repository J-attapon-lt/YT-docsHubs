        ...
        const imageHtml = section.imageUrl
          ? `
            <figure style="margin-top:24px;text-align:center;">
              <img src="${getImageUrl(section.imageUrl)}" style="max-width:100%;max-height:560px;object-fit:contain;border:1px solid #ddd;border-radius:12px;" />
              ${
                section.imageCaption
                  ? `<figcaption style="font-size:13px;color:#666;margin-top:8px;">${section.imageCaption}</figcaption>`
                  : ''
              }
            </figure>
          `
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div
              ...
              dangerouslySetInnerHTML={{
                __html: DOMPurify.sanitize(currentContent?.content || ''),
              }}
            />
                ...
                <div key={`${section.id}-${index}`} className="border rounded-2xl overflow-hidden">
                  ...
                  <div className="p-5 space-y-4">
                    ...
                    <div className="border rounded-xl p-5 bg-blue-50/40">
                      <label className="block text-sm font-bold text-gray-700 mb-2">
                        URL ภาพประกอบจาก Google Drive หรือ URL รูปภาพ
                      </label>
                      ...
                      <input
                        ...
                        placeholder="เช่น ภาพหน้าจอเมนูจัดการคลังสินค้า"
                        className="w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-blue-500 focus:outline-none"
                      />
                      ...
                      {section.imageUrl && (
                        <div className="mt-4 rounded-xl border bg-white p-3">
                          ...
                          <p className="text-xs text-gray-400 mt-2 break-all">
                            URL ที่ใช้จริง: {getImageUrl(section.imageUrl)}
                          </p>
                        </div>
                      )}
                    </div>
